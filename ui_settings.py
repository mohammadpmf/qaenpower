...
SAVE_ICON_SIZE = UPDATE_ICON_SIZE = REFRESH_ICON_SIZE = SETTINGS_ICON_SIZE = DELETE_ICON_SIZE = 64
PADX = 10
PADY = 5
WORDS_WIDTH=15
WORDS_WIDTH2=12
...
def create_my_theme():
    ...
    style.configure("Treeview",background=COLORS['BG'],foreground=COLORS['FG'],rowheight=48,fieldbackground=COLORS['BG'], font=FONT2)
    style.configure("Treeview.Heading", background="#222222", foreground=COLORS['FG2'], font=FONT2)
